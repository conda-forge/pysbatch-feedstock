About pysbatch-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysbatch-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/luptior/pysbatch

Documentation: https://github.com/luptior/pysbatch/blob/master/README.md
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4137&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysbatch-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysbatch` can be installed with `conda`:
...
```
mamba install pysbatch
```

It is possible to list all of the versions of `pysbatch` available on your platform with `conda`:
...
```
mamba search pysbatch --channel conda-forge
```
...
mamba repoquery search pysbatch --channel conda-forge

# List packages depending on `pysbatch`:
mamba repoquery whoneeds pysbatch --channel conda-forge

# List dependencies of `pysbatch`:
mamba repoquery depends pysbatch --channel conda-forge
```
...
* [@luptior](https://github.com/luptior/)
